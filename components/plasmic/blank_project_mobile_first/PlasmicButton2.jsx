...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: bFaaHDiGf2u/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 5l7XfciyvAi/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xSjy2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__psOSs)}
                role={"img"}
              />
            ),
